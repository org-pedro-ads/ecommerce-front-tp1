...
import { NotFound } from './core/shared/not-found/not-found';

export const routes: Routes = [
    {path: '', component: Login},
    {path: 'products/product-management/list', component: ListProducts, canActivate: [adminGuard]},
    {path: 'products/product-management/register-products', component: RegisterProducts, canActivate: [adminGuard]},
    {path: 'products/product-management/edit-products/:id', component: EditProducts, canActivate: [adminGuard]},
